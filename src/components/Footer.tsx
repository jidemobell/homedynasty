      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 text-amber-400">HomeDynastyFurniture</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:info@homedynastyfurniture.com" className="text-stone-300 hover:text-amber-400 transition-colors" title="Email us">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:info@homedynastyfurniture.com" className="text-stone-300 hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-stone-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-stone-300 text-sm">
            © 2024 HomeDynastyFurniture. All rights reserved. Licensed & Insured.
          </p>
